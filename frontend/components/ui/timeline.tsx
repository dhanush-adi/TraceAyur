    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-gray-300 dark:text-gray-300 text-sm md:text-base max-w-sm">
          Track your product's complete journey from origin to your hands through our blockchain-powered supply chain.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-gray-800 dark:bg-gray-800 flex items-center justify-center border border-gray-600">
                <div className="h-4 w-4 rounded-full bg-gray-600 dark:bg-gray-600 border border-gray-500 dark:border-gray-500 p-2" />
              </div>
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-gray-400 dark:text-gray-400 ">
                {item.title}
              </h3>
            </div>
